...
export default function Dashboard() {
  const [selectedFeature, setSelectedFeature] = useState('unified-wallet');
    ...
    if (!Component) {
      return (
        <Card className="h-full">
          ...
          <CardContent>
            <p className="text-slate-600 font-medium">This feature is currently under development.</p>
          </CardContent>
        </Card>
      );
    }
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-hidden">
      ...
      <motion.div
        ...
        className="bg-white border-r border-slate-200 shadow-lg relative backdrop-blur-sm"
      >
        {/* Sidebar Header */}
          ...
          <div className="flex items-center justify-between">
            {sidebarOpen && (
              ...
              >
                ...
                <div>
                  <h1 className="font-bold text-lg text-slate-900">FluxTranche</h1>
                  <p className="text-xs text-slate-600 font-medium">AI-Powered DeFi</p>
                </div>
              </motion.div>
            )}
            <Button
            ...
            >
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/70 backdrop-blur-sm border-slate-200 focus:border-blue-300 focus:ring-2 focus:ring-blue-100"
                />
              </div>
            </motion.div>
          )}
            ...
            >
              {filteredCategories.map((category, categoryIndex) => (
                <div key={category.category} className="space-y-2">
                  ...
                  >
                    <h3 className="px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">
                      {category.category}
                    </h3>
                  </motion.div>
                        ...
                        >
                          <Button
                            ...
                            className={`w-full justify-start h-auto p-3 transition-all duration-200 ${
                              isSelected 
                                ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 text-blue-900 shadow-sm' 
                          ...
                          >
                            <div className="flex items-center gap-3 w-full">
                              ...
                              <div className="text-left flex-1 min-w-0">
                                ...
                                <div className={`text-xs truncate ${isSelected ? 'text-blue-700' : 'text-slate-600'}`}>
                                  {item.description}
                                </div>
                              </div>
                              {isSelected && (
        ...
        {sidebarOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="p-4 border-t border-slate-200 bg-gradient-to-t from-slate-50 to-transparent"
          >
            <div className="space-y-2">
              <Button variant="ghost" size="sm" className="w-full justify-start text-slate-700 hover:text-slate-900 hover:bg-slate-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Feature Content */}
        <div className="flex-1 p-6 overflow-auto bg-gradient-to-b from-transparent to-slate-50/30">
          <motion.div
            key={selectedFeature}
